...
export const createPlayer=(id:0|1):Player=>({id,name:`Player ${id+1}`,score:0,cycle:1,vowelCycle:1,available:[...ALPHABET]})
export const createGame=():GameState=>({board:createBoard(),players:[createPlayer(0),createPlayer(1)],active:0,turn:1,moves:[],passes:[],noMove:[],status:'playing',undo:[]})
